...
> **0.1.3 双版本正式发布：** 新增仙窍红石接口、统一机器三态红石控制与机器分类标签，并完成相关模型、界面、持久化、迷你仙墟渲染和古玉手册更新。完整说明见 [CHANGELOG 0.1.3](CHANGELOG.md#013)，下载见 [GitHub Release 0.1.3](https://github.com/positer/ImmortalStorage/releases/tag/0.1.3)。
