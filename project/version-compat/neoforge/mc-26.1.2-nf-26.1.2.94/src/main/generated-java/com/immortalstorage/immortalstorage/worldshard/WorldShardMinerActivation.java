...
public record WorldShardMinerActivation(Optional<Identifier> blockId,
    ...
    public static WorldShardMinerActivation forBlockId(Identifier blockId) {
        return new WorldShardMinerActivation(Optional.of(Objects.requireNonNull(blockId, "blockId")), Optional.empty());
    }

    public static WorldShardMinerActivation forTag(Identifier tagId) {
