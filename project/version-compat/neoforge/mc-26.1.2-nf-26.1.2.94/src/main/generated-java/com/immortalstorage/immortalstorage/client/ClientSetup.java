...
public final class ClientSetup {
    ...
    private static void registerSpecialModelRenderers(RegisterSpecialModelRendererEvent event) {
        event.register(Identifier.fromNamespaceAndPath(ImmortalStorageMod.MODID, "dynamic_preview"),
                com.immortalstorage.immortalstorage.client.render.DynamicPreviewBlockItemRenderer.Unbaked.MAP_CODEC);
        event.register(Identifier.fromNamespaceAndPath(ImmortalStorageMod.MODID, "source_vein"),
                com.immortalstorage.immortalstorage.client.render.SourceVeinItemRenderer.Unbaked.MAP_CODEC);
        event.register(Identifier.fromNamespaceAndPath(ImmortalStorageMod.MODID, "source_vein_manager"),
                com.immortalstorage.immortalstorage.client.render.SourceVeinManagerItemRenderer.Unbaked.MAP_CODEC);
    }
