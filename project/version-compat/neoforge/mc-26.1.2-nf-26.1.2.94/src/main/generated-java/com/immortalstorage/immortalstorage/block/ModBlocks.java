...
public final class ModBlocks {
    ...
    private static Supplier<Block> reg(String id, Supplier<Block> b, @Nullable CrystalKind ignoredKind) {
        ...
        ModItems.ITEMS.register(id, () -> ro.get() instanceof SourceVeinBlock source
                ? new SourceVeinBlockItem(source, ModItems.setItemId(id, new Item.Properties().useBlockDescriptionPrefix()))
                : ro.get() instanceof SourceVeinManagerBlock manager
                ? new SourceVeinManagerBlockItem(manager, ModItems.setItemId(id, new Item.Properties().useBlockDescriptionPrefix()))
                : new BlockItem(ro.get(), ModItems.setItemId(id, new Item.Properties().useBlockDescriptionPrefix())));
        return ro;
    }
