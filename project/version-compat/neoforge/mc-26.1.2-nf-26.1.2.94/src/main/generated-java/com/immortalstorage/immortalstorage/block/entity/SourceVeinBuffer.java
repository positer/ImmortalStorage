...
public final class SourceVeinBuffer {
    ...
    public void load(CompoundTag tag) {
        available = Math.max(0L, Math.min(capacity, tag.getLongOr(TAG, 0L)));
    }
     ...
     * its charge still rounds up through {@link com.immortalstorage.immortalstorage.api.source.SourceChargePlan}.
     */
