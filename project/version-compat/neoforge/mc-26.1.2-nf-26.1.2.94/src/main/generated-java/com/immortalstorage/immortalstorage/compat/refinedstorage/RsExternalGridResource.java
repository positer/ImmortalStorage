...
final class RsExternalGridResource extends AbstractGridResource<RsExternalResource> {
    ...
    RsExternalResource externalResource() { return resource; }
    ...
    @Override public ResourceAmount createAutocraftingRequest() {
    ...
    @Override public void render(GuiGraphicsExtractor graphics, int x, int y) {
    ...
    @Override public boolean is(GridResource other) {
        return other instanceof RsExternalGridResource that && resource.equals(that.resource);
    }

    @Override public com.refinedmods.refinedstorage.common.api.grid.view.GridResourceType getType() { return RsExternalGridResourceType.INSTANCE; }
