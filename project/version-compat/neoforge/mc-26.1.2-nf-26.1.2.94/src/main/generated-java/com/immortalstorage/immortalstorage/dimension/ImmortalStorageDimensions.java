...
public final class ImmortalStorageDimensions {
    ...
    public static final Identifier XIANQIAO_REALM_TEMPLATE_LOCATION =
            Identifier.fromNamespaceAndPath(ImmortalStorageMod.MODID, "xianqiao_realm");
    ...
    public static Identifier personalRealmLocation(UUID playerId) {
        String stableId = playerId.toString().replace("-", "").toLowerCase(Locale.ROOT);
        return Identifier.fromNamespaceAndPath(ImmortalStorageMod.MODID, XIANQIAO_REALM_PREFIX + stableId);
    }
