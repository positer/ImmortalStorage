...
public final class WorldShardAddonRegistry {
    private static final Map<Identifier, WorldShardMinerMode> MINER_MODES = new ConcurrentHashMap<>();
    private static final Map<Identifier, WorldShardLootDefinition> LOOT_DEFINITIONS = new ConcurrentHashMap<>();
