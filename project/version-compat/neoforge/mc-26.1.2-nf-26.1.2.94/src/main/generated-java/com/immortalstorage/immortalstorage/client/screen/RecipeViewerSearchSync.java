...
final class RecipeViewerSearchSync {
    ...
    static void push(String text) {
        if (!ImmortalStorageClientConfig.SYNC_RECIPE_VIEWER_SEARCH.get()) {
            return;
        }
        ...
        if (ModList.get().isLoaded("jei")) {
            invokeStatic("com.immortalstorage.immortalstorage.compat.jei.ImmortalStorageJeiPlugin",
    ...
    static Optional<String> externalText() {
        ...
        if (ModList.get().isLoaded("jei")) {
            Object focused = invokeStatic("com.immortalstorage.immortalstorage.compat.jei.ImmortalStorageJeiPlugin",
                    "isSearchFocused", new Class<?>[0]);
            if (Boolean.TRUE.equals(focused)) {
                Object value = invokeStatic("com.immortalstorage.immortalstorage.compat.jei.ImmortalStorageJeiPlugin",
