...
public final class AdvancedStabilizedMiniatureImmortalRuinRenderer extends LegacyBlockEntityRenderer<AdvancedStabilizedMiniatureImmortalRuinBlockEntity> {
    public AdvancedStabilizedMiniatureImmortalRuinRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void legacyRender(AdvancedStabilizedMiniatureImmortalRuinBlockEntity entity, float partialTick, PoseStack poses,
