...
final class SourceVeinSideModeContractTest {
    ...
    void legacyNbtNeverEscalatesExtractToOutputOrPushToBypass() {
        ...
        source.loadAdditionalLegacy(legacy, registries);
        ...
        int[] migratedModes = migrated.getIntArray("SideModes").orElseGet(() -> new int[0]);
    ...
    void separateBlocksKeepIndependentRatesAndModesAcrossPersistence() {
        ...
        reloadedFirst.loadAdditionalLegacy(save(first), registries);
        reloadedSecond.loadAdditionalLegacy(save(second), registries);
