...
final class YuanStorageBoundaryTest {
    ...
    static void bootstrapMinecraftRegistries() {
        ...
        trueYuanItem = Registry.register(BuiltInRegistries.ITEM,
                Identifier.fromNamespaceAndPath("cultivation_test", "true_yuan"),
                new TrueYuanItem(new Item.Properties().setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ITEM, net.minecraft.resources.Identifier.fromNamespaceAndPath("cultivation_test", "true_yuan"))).stacksTo(64)));
        immortalYuanItem = Registry.register(BuiltInRegistries.ITEM,
                Identifier.fromNamespaceAndPath("cultivation_test", "immortal_yuan"),
                new ImmortalYuanItem(new Item.Properties().setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ITEM, net.minecraft.resources.Identifier.fromNamespaceAndPath("cultivation_test", "immortal_yuan"))).stacksTo(64)));
