...
final class SimulatedReincarnationFurnaceInventoryMigrationTest {
    ...
    void fifteenSlotSharedInventoryKeepsExistingOutputs() {
        ...
        saved.put("Items", com.immortalstorage.immortalstorage.compat.mc2612.CompatValueIo.serialize(legacy, registries));
        ...
        furnace.loadAdditionalLegacy(saved, registries);
