...
final class WorldShardUnifiedOutputTest {
    ...
    static void bootstrapMinecraftRegistries() {
        ...
        immortalYuan = Registry.register(BuiltInRegistries.ITEM,
                Identifier.fromNamespaceAndPath("cultivation_world_shard_test", "immortal_yuan"),
                new ImmortalYuanItem(new Item.Properties().setId(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ITEM, net.minecraft.resources.Identifier.fromNamespaceAndPath("cultivation_world_shard_test", "immortal_yuan"))).stacksTo(64)));
    ...
    void exactOwnerPersonalRealmWritesComponentDistinctOutputsDirectlyIntoUnifiedXianqiao() {
        ImmortalStoragePlayerData ownerData = new ImmortalStoragePlayerData();
    ...
    private static PersonalStorageNetwork.Endpoint endpoint(ImmortalStoragePlayerData data) {
