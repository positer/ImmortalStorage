...
final class ZeroPointZeroPointFourContractTest {
    ...
    private static final Path TARGET_SOURCE_ROOT = ROOT.resolve(Path.of("..", "version-compat", "neoforge", "mc-26.1.2-nf-26.1.2.94", "src", "test", "compat-source"))
            .normalize();
    ...
    @Test void terminalSmithingAndViewerTransferAreWired() throws Exception {
        ...
        assertFalse(Files.exists(TARGET_SOURCE_ROOT.resolve(Path.of("com", "immortalstorage", "immortalstorage", "compat", "emi", "ImmortalStorageEmiPlugin.java"))),
    ...
    private static String source(String relative) throws Exception {
        return Files.readString(ROOT.resolve("../version-compat/neoforge/mc-26.1.2-nf-26.1.2.94/src/test/compat-source/com/immortalstorage/immortalstorage").resolve(relative));
    }
