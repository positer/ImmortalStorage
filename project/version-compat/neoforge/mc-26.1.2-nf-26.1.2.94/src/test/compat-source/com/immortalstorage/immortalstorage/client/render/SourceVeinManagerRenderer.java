 ...
 */
public final class SourceVeinManagerRenderer extends LegacyBlockEntityRenderer<SourceVeinManagerBlockEntity> {
    ...
    @Override
    public void legacyRender(SourceVeinManagerBlockEntity manager,
                       float partialTick,
                       PoseStack poseStack,
                       MultiBufferSource buffers,
                       int packedLight,
                       int packedOverlay, net.minecraft.world.phys.Vec3 cameraPosition) {
    ...
    private static RenderType materialType(String texture) {
        return CompatRenderTypes.entityTranslucentEmissive(Identifier
