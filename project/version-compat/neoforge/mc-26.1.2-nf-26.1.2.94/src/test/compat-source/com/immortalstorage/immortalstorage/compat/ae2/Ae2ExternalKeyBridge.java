 ...
 * ImmortalStorage's loader-neutral external-resource ledger.
 *
 * <p>Implementations belong to isolated compatibility packages and are only
 * registered when every required mod is present.</p>
 */
public interface Ae2ExternalKeyBridge extends ExternalResourceKeyBridge<AEKey> {
    ...
    @Override
    default @Nullable AEKey toNativeKey(ResourceChannelKey key) {
        return toAeKey(key);
    }
}
