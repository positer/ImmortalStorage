...
public final class WorldShardApi {
    ...
    public static Map<Identifier, WorldShardMinerMode> minerModes() {
        return WorldShardMinerModes.definitions();
    }

    /** The resolved mode, including its sampled ore pool, for {@code id}. */
    public static Optional<WorldShardMinerModes.ResolvedMode> resolvedMinerMode(Identifier id) {
    ...
    public static List<WorldShardLootDefinition> lootDefinitions(Identifier mode) {
    ...
    public static boolean hasSelectableLoot(Identifier mode) {
        Objects.requireNonNull(mode, "mode");
