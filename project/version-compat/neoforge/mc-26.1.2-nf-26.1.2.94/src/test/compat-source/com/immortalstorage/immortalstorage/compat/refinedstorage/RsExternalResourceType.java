...
/** Serializable RS resource type for all ImmortalStorage external channels. */
public final class RsExternalResourceType implements ResourceType {
    ...
    private static final Identifier FALLBACK_SPRITE = Identifier.fromNamespaceAndPath(
