...
public record WorldShardMinerMode(Identifier id,
    ...
    public WorldShardMinerMode(Identifier id,
                               WorldShardMinerActivation activation,
                               Optional<Identifier> targetDimension,
                               Optional<TagKey<Biome>> targetBiomeTag,
                               int beamColor,
