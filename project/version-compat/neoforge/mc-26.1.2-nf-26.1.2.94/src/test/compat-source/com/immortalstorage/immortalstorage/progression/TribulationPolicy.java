...
public final class TribulationPolicy {
    ...
    public static Identifier defaultTargetId(int currentStage) {
        return switch (currentStage) {
            case 6 -> Identifier.withDefaultNamespace("zombie");
            case 7 -> Identifier.withDefaultNamespace("wither_skeleton");
            case 8 -> Identifier.withDefaultNamespace("vindicator");
            case 9 -> Identifier.withDefaultNamespace("warden");
            default -> Identifier.withDefaultNamespace("zombie");
        };
    }
