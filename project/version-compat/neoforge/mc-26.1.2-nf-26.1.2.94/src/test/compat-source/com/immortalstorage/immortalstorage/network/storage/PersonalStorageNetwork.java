...
public final class PersonalStorageNetwork {
    ...
    public static @Nullable Endpoint resolveInOwnerRealm(
        ...
        if (realm == null || realm.isClientSide() || owner == null || com.immortalstorage.immortalstorage.compat.mc2612.CompatLevel.server(realm) == null) return null;
        if (!ImmortalStorageDimensions.isPersonalRealmFor(realm.dimension(), owner)) return null;
        MinecraftServer boundServer = com.immortalstorage.immortalstorage.compat.mc2612.CompatLevel.server(realm);
        ...
        BooleanSupplier accessAllowed = () -> {
            ...
            return currentPlayer != null
                    && ImmortalStoragePlayerData.get(currentPlayer) == data
                    && data.getStage() >= 6
                    && com.immortalstorage.immortalstorage.compat.mc2612.CompatLevel.server(realm) == boundServer
