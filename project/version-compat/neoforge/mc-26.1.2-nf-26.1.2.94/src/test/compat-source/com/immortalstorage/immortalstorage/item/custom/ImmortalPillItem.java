...
import com.immortalstorage.immortalstorage.progression.AscensionCosmeticEffects;
...
public class ImmortalPillItem extends com.immortalstorage.immortalstorage.compat.mc2612.CompatItem {
    private static final int UNBOUNDED_REWARD_TICKS = 2_000;
    public ImmortalPillItem(Properties props) {
        super(props.food(new FoodProperties.Builder().nutrition(20).saturationModifier(20f).alwaysEdible().build(),
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity ent) {
        ...
        if (!level.isClientSide() && ent instanceof Player p && p.level() instanceof ServerLevel sl) {
            ...
            } else if (st == 5 && com.immortalstorage.immortalstorage.progression.ImmortalStorageProgressionRules
    ...
    static long immortalYuanReward(ImmortalStoragePlayerData data) {
