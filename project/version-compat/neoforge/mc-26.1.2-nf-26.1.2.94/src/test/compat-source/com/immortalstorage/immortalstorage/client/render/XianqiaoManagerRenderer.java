...
public final class XianqiaoManagerRenderer extends LegacyBlockEntityRenderer<XianqiaoManagerBlockEntity> {
    ...
    @Override
    public void legacyRender(XianqiaoManagerBlockEntity blockEntity,
                       float partialTick,
                       PoseStack poseStack,
