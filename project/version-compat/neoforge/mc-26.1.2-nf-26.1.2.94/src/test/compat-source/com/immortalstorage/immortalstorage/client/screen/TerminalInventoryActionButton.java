...
final class TerminalInventoryActionButton extends Button {
    ...
    protected void extractContents(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        com.immortalstorage.immortalstorage.compat.mc2612.CompatGui.blitSprite(graphics, net.minecraft.resources.Identifier.withDefaultNamespace(
                        this.active
    ...
    private static void renderWrench(GuiGraphicsExtractor graphics, int x, int y) {
        int dark = 0xFF303030;
    ...
    private static void renderArrow(GuiGraphicsExtractor graphics, int x, int y, int color, boolean up) {
