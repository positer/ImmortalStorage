...
final class TerminalTabButton extends Button {
    ...
    protected void extractContents(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        com.immortalstorage.immortalstorage.compat.mc2612.CompatGui.blitSprite(graphics, TerminalTabStyle.sprite(this.side, this.segment, selectedNow),
        ...
        if (!this.active) {
            ...
            graphics.outline(getX() + 4, getY() + 3,
