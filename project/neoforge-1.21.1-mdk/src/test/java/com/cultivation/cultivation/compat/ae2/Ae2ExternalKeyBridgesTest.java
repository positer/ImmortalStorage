...
final class Ae2ExternalKeyBridgesTest {
    ...
    @Test
    void addonCanonicalKeyWinsOverCultivationFallbackWithoutRejectingEitherInput() {
        ...
        CultivationExternalResourceKey fallback =
                new CultivationExternalResourceKey(ExternalResourceChannels.BOTANIA_MANA);
    ...
    void cultivationOwnedKeyRoundTripsWithoutTargetModClasses() {
        ...
        CultivationExternalResourceKey key = new CultivationExternalResourceKey(chemical);

        assertEquals(chemical, key.resource());
        assertEquals(key, CultivationExternalResourceKey.fromTag(key.toTag(null)));
        assertNull(CultivationExternalResourceKey.fromTag(new net.minecraft.nbt.CompoundTag()));
