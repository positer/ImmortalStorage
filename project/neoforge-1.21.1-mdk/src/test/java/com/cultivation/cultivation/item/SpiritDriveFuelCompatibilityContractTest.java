...
final class SpiritDriveFuelCompatibilityContractTest {
    ...
    void driveIsDiscoverableInStandardFuelSlotsButPaymentRemainsServerAuthoritative() throws Exception {
        ...
        String item = Files.readString(root.resolve("java/com/cultivation/cultivation/item/custom/SpiritDriveItem.java"));
        String mixin = Files.readString(root.resolve("java/com/cultivation/cultivation/mixin/core/AbstractFurnaceSpiritDriveMixin.java"));
        ...
        for (String path : new String[]{"resources/data/c/tags/item/fuels.json",
            ...
            assertTrue(Files.readString(root.resolve(path)).contains("cultivation:spirit_drive"));
        }
    }
