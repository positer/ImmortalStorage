...
final class SourceDefinitionTest {
    ...
    void higherPriorityLayerOverridesBuiltinByStableDefinitionId() {
        Map<ResourceLocation, SourceDefinition> builtins = SourceDefinitions.builtinDefinitions();
        ResourceLocation cobbleId = SourceDefinitions.legacyId(VeinKind.COBBLE);
        ...
        Map<ResourceLocation, SourceDefinition> merged = SourceDefinitions.merge(builtins, List.of(override));
