...
final class Ae2ExternalKeyBridgesTest {
    ...
    void cultivationOwnedKeyRoundTripsWithoutTargetModClasses() {
        ...
        assertEquals(key, ImmortalStorageExternalResourceKey.fromTag(key.toTag(null)));
        assertNull(ImmortalStorageExternalResourceKey.fromTag(new net.minecraft.nbt.CompoundTag()));
