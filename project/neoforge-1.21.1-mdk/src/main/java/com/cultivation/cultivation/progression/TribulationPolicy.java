...
public final class TribulationPolicy {
    ...
    public static int configuredMaximumStage() {
        return clampMaximumStage(CultivationConfig.NORMAL_PROGRESSION_MAX_STAGE.get());
    }
    ...
    public static String configuredTargetId(int currentStage) {
        return switch (currentStage) {
            case 6 -> CultivationConfig.TRIBULATION_TARGET_STAGE_6.get();
            case 7 -> CultivationConfig.TRIBULATION_TARGET_STAGE_7.get();
            case 8 -> CultivationConfig.TRIBULATION_TARGET_STAGE_8.get();
            case 9 -> CultivationConfig.TRIBULATION_TARGET_STAGE_9.get();
