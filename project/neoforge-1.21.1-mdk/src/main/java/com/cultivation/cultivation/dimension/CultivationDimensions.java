...
public final class CultivationDimensions {
    ...
    public static final ResourceLocation XIANQIAO_REALM_TEMPLATE_LOCATION =
            ResourceLocation.fromNamespaceAndPath(CultivationMod.MODID, "xianqiao_realm");
    ...
    public static final DeferredRegister<MapCodec<? extends ChunkGenerator>> CHUNK_GENERATOR_CODECS =
            DeferredRegister.create(Registries.CHUNK_GENERATOR, CultivationMod.MODID);
    ...
    public static void register() {
        // Registries register themselves via the FML bus (see CultivationMod constructor).
    ...
    public static ResourceLocation personalRealmLocation(UUID playerId) {
        ...
        return ResourceLocation.fromNamespaceAndPath(CultivationMod.MODID, XIANQIAO_REALM_PREFIX + stableId);
    }
    ...
    public static boolean isXianqiaoRealm(ResourceKey<Level> key) {
        ...
        return CultivationMod.MODID.equals(location.getNamespace())
    ...
    public static Optional<UUID> personalRealmOwner(ResourceKey<Level> key) {
        ResourceLocation location = key.location();
        if (!CultivationMod.MODID.equals(location.getNamespace())) {
