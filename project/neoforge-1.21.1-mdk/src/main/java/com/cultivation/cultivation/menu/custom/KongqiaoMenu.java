...
public class KongqiaoMenu extends AbstractContainerMenu implements StorageTerminalView, CraftingTransferTarget {
    ...
    private void sendRecipeSourcesIfChanged(ServerPlayer serverPlayer) {
        ...
        com.cultivation.cultivation.network.ModNetwork.sendRecipeSources(serverPlayer, this, sources, revision);
    }
    ...
    public CultivationPlayerData getData() {
        return data;
    }
    ...
    public static class KongqiaoStorageContainer implements Container {
        ...
        public KongqiaoStorageContainer(CultivationPlayerData data) {
            this.data = data;
        }

        @Override
        public int getContainerSize() {
            return CultivationPlayerData.KONGQIAO_MAX_SLOTS_CEILING;
        }
