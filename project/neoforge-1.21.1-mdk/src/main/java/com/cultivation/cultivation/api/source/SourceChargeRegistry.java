...
public final class SourceChargeRegistry {
    public static final ResourceLocation IMMORTAL_YUAN =
            ResourceLocation.fromNamespaceAndPath("cultivation", "immortal_yuan");

    private static final Map<ResourceLocation, SourceChargeProvider> PROVIDERS = new ConcurrentHashMap<>();
    private static final AtomicBoolean FROZEN = new AtomicBoolean(false);

    public static void register(ResourceLocation id, SourceChargeProvider provider) {
