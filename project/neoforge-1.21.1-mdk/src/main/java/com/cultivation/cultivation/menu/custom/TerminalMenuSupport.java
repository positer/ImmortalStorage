...
final class TerminalMenuSupport {
    ...
    static void returnCraftingItems(AbstractContainerMenu menu, Player player, Container crafting,
                                    CultivationPlayerData data, boolean xianqiao) {
    ...
    static ItemStack insertXianqiao(CultivationPlayerData data, ItemStack stack) {
        return data.insertStackFromPlayerInventory(stack.copy());
    }

    static ItemStack insertKongqiao(CultivationPlayerData data, ItemStack stack) {
