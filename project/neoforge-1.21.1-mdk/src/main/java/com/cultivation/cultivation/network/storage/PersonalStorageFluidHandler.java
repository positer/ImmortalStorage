...
public final class PersonalStorageFluidHandler implements IFluidHandler, TerminalFluidStorage {
    ...
    private boolean isAvailable() {
        return data.getStage() >= CultivationPlayerData.XIANQIAO_FLUID_UNLOCK_STAGE
                && accessAllowed.getAsBoolean();
    }

    public PersonalStorageFluidHandler(CultivationPlayerData data, Runnable onChanged) {
        this(data, onChanged, () -> true);
    }

    public PersonalStorageFluidHandler(CultivationPlayerData data, Runnable onChanged, BooleanSupplier accessAllowed) {
