...
public class XianqiaoRealmChunkGenerator extends ChunkGenerator {
    ...
    private static FixedBiomeSource createBiomeSource(HolderGetter<Biome> biomeRegistry) {
        return new FixedBiomeSource(biomeRegistry.getOrThrow(CultivationDimensions.XIANQIAO_REALM_BIOME));
    }
    ...
    @Override
    public void applyCarvers(WorldGenRegion l, long seed, RandomState r, BiomeManager bm, StructureManager s, ChunkAccess c, GenerationStep.Carving carving) {}
