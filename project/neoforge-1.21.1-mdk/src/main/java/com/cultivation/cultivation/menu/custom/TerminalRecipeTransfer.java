...
final class TerminalRecipeTransfer {
    static boolean place(AbstractContainerMenu menu, Player actor, CultivationPlayerData data,
    ...
    private record State(List<ItemStack> grid, List<ItemStack> storage, List<ItemStack> inventory,
        ...
        static State capture(ServerPlayer player, CultivationPlayerData data, CraftingContainer grid,
                             boolean xianqiao) {
