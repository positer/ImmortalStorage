package com.cultivation.cultivation.menu;
...
import com.cultivation.cultivation.menu.custom.SourceVeinManagerMenu;
...
public final class ModMenus {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(Registries.MENU, CultivationMod.MODID);
