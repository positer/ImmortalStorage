...
public final class TerminalLayout {
    ...
    public static int configuredRows() {
        return clampDesiredRows(CultivationClientConfig.TERMINAL_ROWS.get());
    }

    public static void setConfiguredRows(int rows) {
        CultivationClientConfig.TERMINAL_ROWS.set(clampDesiredRows(rows));
        CultivationClientConfig.TERMINAL_ROWS.save();
    }
