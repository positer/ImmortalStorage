...
public final class ModCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CultivationMod.MODID);

    public static final Supplier<CreativeModeTab> CULTIVATION = TABS.register("cultivation",
            () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ModItems.JADE_GUIDE.get()))
                    .title(Component.translatable("itemGroup.cultivation"))
