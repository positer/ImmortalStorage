...
public final class AdvancedEntangledStabilizedMiniatureImmortalRuinRenderer implements BlockEntityRenderer<AdvancedEntangledStabilizedMiniatureImmortalRuinBlockEntity> {
    ...
    @Override
    public void render(AdvancedEntangledStabilizedMiniatureImmortalRuinBlockEntity entity, float partialTick, PoseStack poses,
    ...
    @Override public boolean shouldRenderOffScreen(AdvancedEntangledStabilizedMiniatureImmortalRuinBlockEntity entity) { return true; }
