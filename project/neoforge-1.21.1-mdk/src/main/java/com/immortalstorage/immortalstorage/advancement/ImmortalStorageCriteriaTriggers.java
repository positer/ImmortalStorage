package com.immortalstorage.immortalstorage.advancement;
...
public final class ImmortalStorageCriteriaTriggers {
    ...
    public static void onRegister(RegisterEvent event) {
        event.register(Registries.TRIGGER_TYPE, reg -> {
            STAGE_1 = registerTrigger("immortalstorage_stage_1");
            STAGE_2 = registerTrigger("immortalstorage_stage_2");
            STAGE_3 = registerTrigger("immortalstorage_stage_3");
            STAGE_4 = registerTrigger("immortalstorage_stage_4");
            STAGE_5 = registerTrigger("immortalstorage_stage_5");
            STAGE_6 = registerTrigger("immortalstorage_stage_6");
            STAGE_7 = registerTrigger("immortalstorage_stage_7");
            STAGE_8 = registerTrigger("immortalstorage_stage_8");
            STAGE_9 = registerTrigger("immortalstorage_stage_9");
