...
public final class CompatManager {
    ...
    private static void registerExternalResourceCatalogues() {
        ExternalResourceCatalog.register(
                ResourceLocation.fromNamespaceAndPath(ImmortalStorageMod.MODID, "builtin_external_resources"),
                () -> List.of(
    ...
    private static ResourceLocation builtinAddonTexture(String name) {
        return ResourceLocation.fromNamespaceAndPath(ImmortalStorageMod.MODID,
