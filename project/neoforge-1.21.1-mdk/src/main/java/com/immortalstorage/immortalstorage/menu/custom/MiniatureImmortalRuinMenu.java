...
public final class MiniatureImmortalRuinMenu extends AbstractContainerMenu {
    ...
    public MiniatureImmortalRuinMenu(int id, Inventory inventory, FriendlyByteBuf buffer) { this(id, inventory, new SimpleContainerData(5)); }
    ...
    @Override public boolean clickMenuButton(Player player, int id) { if (id >= 0 && id < 3 || id == 4) { data.set(id, data.get(id) == 0 ? 1 : 0); return true; } if (id == 3) { data.set(3, (data.get(3) + 1) % 5); return true; } return false; }
