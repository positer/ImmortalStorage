...
import com.immortalstorage.immortalstorage.client.guide.JadeGuideBook;
import com.immortalstorage.immortalstorage.client.guide.JadeGuideCategory;
import com.immortalstorage.immortalstorage.client.guide.JadeGuideChapter;
import com.immortalstorage.immortalstorage.client.guide.JadeGuideHistory;
import com.immortalstorage.immortalstorage.client.guide.JadeGuideLocation;
import com.immortalstorage.immortalstorage.client.guide.JadeGuidePage;
import com.immortalstorage.immortalstorage.client.guide.JadeGuidePaginator;
import com.immortalstorage.immortalstorage.client.guide.JadeGuideProgression;
import com.immortalstorage.immortalstorage.client.guide.JadeGuideSearch;
import com.immortalstorage.immortalstorage.client.guide.JadeGuideSession;
...
public final class JadeGuideScreen extends Screen {
    ...
    public JadeGuideScreen() {
        super(Component.translatable("guide.immortalstorage.jade.title"));
    }
    ...
    protected void init() {
        ...
        ImmortalStoragePlayerData playerData = minecraft != null && minecraft.player != null
                ? ImmortalStoragePlayerData.get(minecraft.player) : null;
        ...
        searchBox = new EditBox(font, left + 105, top + 11, 146, 12,
                Component.translatable("guide.immortalstorage.jade.search"));
        searchBox.setHint(Component.translatable("guide.immortalstorage.jade.search_hint"));
        ...
        historyBack = addRenderableWidget(Button.builder(Component.literal("<"), ignored -> navigateHistory(false))
                ...
                .tooltip(Tooltip.create(Component.translatable("guide.immortalstorage.jade.history_back")))
                .build());
        historyForward = addRenderableWidget(Button.builder(Component.literal(">"), ignored -> navigateHistory(true))
                ...
                .tooltip(Tooltip.create(Component.translatable("guide.immortalstorage.jade.history_forward")))
                .build());
        addRenderableWidget(Button.builder(Component.literal("H"), ignored -> showHome(true))
                .bounds(left + 254, top + 11, 16, 12)
                .tooltip(Tooltip.create(Component.translatable("guide.immortalstorage.jade.home")))
                .build());
    ...
    private Component rightHeading() {
        return switch (mode) {
            case HOME, CATEGORY -> Component.translatable("guide.immortalstorage.jade.chapters");
            case CHAPTER -> Component.translatable("guide.immortalstorage.jade.details");
            case SEARCH -> Component.translatable("guide.immortalstorage.jade.search_results", searchResults.size());
        };
    }

    private void renderHome(GuiGraphics graphics, int left, int top) {
        renderRuntimeIcon(graphics, ResourceLocation.parse("immortalstorage:jade_guide"),
        ...
        graphics.drawString(font, Component.translatable("guide.immortalstorage.jade.next_goal"),
    ...
    private void renderUnlockProgress(GuiGraphics graphics, int x, int y) {
        ...
        graphics.drawString(font, Component.translatable("guide.immortalstorage.jade.unlock_progress", unlocked, total),
    ...
    private void renderCategory(GuiGraphics graphics, int left, int top) {
        ...
        drawWrappedText(graphics, Component.translatable("guide.immortalstorage.jade.category." + category.id() + ".summary"),
        ...
        graphics.drawString(font, Component.translatable("guide.immortalstorage.jade.category_progress",
    ...
    private void renderSearch(GuiGraphics graphics, int left, int top) {
        if (searchResults.isEmpty()) {
            graphics.drawString(font, Component.translatable("guide.immortalstorage.jade.search_empty"),
        ...
        if (chapter.id().equals("progression.recipes")) {
            ...
            if (recipes.isEmpty()) {
                return List.of(new JadeGuidePage(Component.translatable(chapter.titleKey()).getString(),
                        List.of(Component.translatable("guide.immortalstorage.jade.recipes.empty").getString())));
            }
    ...
    private List<String> recipeParagraphs() {
        if (minecraft == null || minecraft.level == null) {
            return List.of(Component.translatable("guide.immortalstorage.jade.recipes.unavailable").getString());
        }
        List<String> paragraphs = new ArrayList<>();
        minecraft.level.getRecipeManager().getRecipes().stream()
                .filter(holder -> holder.id().getNamespace().equals("immortalstorage"))
    ...
    private void renderRecipePage(GuiGraphics graphics, int x, int y, int pageIndex) {
        ...
        String type = recipe instanceof AbstractCookingRecipe
                ? Component.translatable("guide.immortalstorage.jade.recipes.cooking").getString()
                : recipe instanceof CraftingRecipe
                ? Component.translatable("guide.immortalstorage.jade.recipes.crafting").getString()
    ...
    private void renderCookingRecipePage(GuiGraphics graphics, AbstractCookingRecipe recipe,
        ...
        graphics.drawCenteredString(font,
                Component.translatable("guide.immortalstorage.jade.recipes.cooking"),
    ...
    private String formatRecipe(RecipeHolder<?> holder) {
        ...
        return Component.translatable("guide.immortalstorage.jade.recipes.entry", output, type,
            ...
            case HOME -> {
                ...
                if (!session.recent().isEmpty()) {
                    ...
                    if (recent != null) addDynamic(Button.builder(
                                    Component.translatable("guide.immortalstorage.jade.recent",
            ...
            case CATEGORY -> {
                ...
                for (JadeGuideChapter chapter : book.chaptersIn(selectedCategory)) {
                    ...
                    if (!chapter.isUnlocked(stage)) label.append(Component.literal(" ["))
                            .append(Component.translatable("guide.immortalstorage.jade.lock.short"))
    ...
    private Component screenHeading() {
        return switch (mode) {
            case HOME -> Component.translatable("guide.immortalstorage.jade.title");
            case CATEGORY -> book.categories().stream().filter(category -> category.id().equals(selectedCategory))
                    ...
                    .orElseGet(() -> Component.translatable("guide.immortalstorage.jade.title"));
            case CHAPTER -> selectedChapter == null ? Component.translatable("guide.immortalstorage.jade.title")
    ...
    public Component getNarrationMessage() {
        return Component.translatable("guide.immortalstorage.jade.narration", screenHeading(),
    ...
    protected void updateNarrationState(NarrationElementOutput output) {
        ...
        output.add(NarratedElementType.USAGE, Component.translatable("guide.immortalstorage.jade.narration_usage"));
