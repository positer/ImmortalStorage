...
public final class JadeGuideBook {
    private static final String LOCK_KEY = "guide.immortalstorage.jade.lock.stage";
    ...
    private static JadeGuideBook createDefault() {
        List<JadeGuideCategory> categories = List.of(
                category("progression", "immortalstorage:jade_guide"),
                category("storage", "minecraft:chest"),
                category("resources", "immortalstorage:immortal_furnace"),
                category("tools", "immortalstorage:spirit_staff"),
                category("realm_compat", "minecraft:ender_eye"));

        List<JadeGuideChapter> chapters = new ArrayList<>();
        chapters.add(chapter("progression.overview", "progression", 10, 1, "immortalstorage:jade_guide"));
        chapters.add(chapter("progression.tasks", "progression", 15, 0, "immortalstorage:jade_guide"));
        chapters.add(chapter("progression.yuan", "progression", 20, 1, "immortalstorage:true_yuan"));
        chapters.add(chapter("progression.ascension", "progression", 30, 5, "immortalstorage:immortal_yuan"));
        ...
        chapters.add(chapter("storage.terminal", "storage", 120, 6, "immortalstorage:xianqiao_manager"));
        chapters.add(chapter("storage.magnet", "storage", 130, 6, "minecraft:compass"));
        chapters.add(chapter("resources.furnace", "resources", 210, 5, "immortalstorage:immortal_furnace"));
        chapters.add(chapter("resources.sources", "resources", 220, 6, "immortalstorage:water_vein"));
        chapters.add(chapter("resources.infrastructure", "resources", 230, 6, "immortalstorage:source_vein_manager"));
        chapters.add(chapter("resources.catalog", "resources", 240, 0, "immortalstorage:spirit_core"));
        chapters.add(chapter("tools.staff", "tools", 310, 1, "immortalstorage:spirit_staff"));
        chapters.add(chapter("tools.sword", "tools", 320, 1, "immortalstorage:spirit_sword"));
        chapters.add(chapter("realm_compat.realm", "realm_compat", 410, 6, "minecraft:ender_eye"));
        chapters.add(chapter("realm_compat.tribulation", "realm_compat", 420, 6, "immortalstorage:white_day_thunder"));
        chapters.add(chapter("realm_compat.world", "realm_compat", 430, 6, "immortalstorage:world_shard_miner"));
        chapters.add(chapter("realm_compat.integration", "realm_compat", 440, 6, "immortalstorage:spirit_drive"));
        return new JadeGuideBook(categories, chapters);
    }

    private static JadeGuideCategory category(String id, String icon) {
        return new JadeGuideCategory(id, "guide.immortalstorage.jade.category." + id,
    ...
    private static JadeGuideChapter chapter(String id, String category, int order, int stage, String icon) {
        String prefix = "guide.immortalstorage.jade.chapter." + id;
